...
parser.add_argument('--batch',dest='batch_size',type=int , default = 5 , help='batch_size for training')
...
parser.add_argument('--mae_weight', dest='mae_weight',type=float, default=50.0,help='weight of mse loss')
